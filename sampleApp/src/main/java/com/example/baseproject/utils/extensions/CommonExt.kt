...
import com.example.baseproject.utils.extensions.checkString
import com.example.baseproject.utils.extensions.containsZeroAfterDecimal
import com.example.baseproject.utils.extensions.getLength
...
fun getMimeTypeFromStringUrl(url: String): String? {
    return when {
        ...
        getFileExtensionFromUrl(url).equals(".jpg") || getFileExtensionFromUrl(url).equals(".jpeg") || getFileExtensionFromUrl(url).equals(".png") -> {
            // JPG file
            "image/jpeg"
        }
