...
import com.example.baseproject.utils.Const.Drawable.END
import com.example.baseproject.utils.Const.Drawable.START
...
fun EditText.isValidPhone(selectedCountryCode: String): Boolean {

    val phoneUtil = PhoneNumberUtil.getInstance()
    var swissNumberProto: Phonenumber.PhoneNumber? = null
    try {
        swissNumberProto = phoneUtil.parse(this.checkString(), selectedCountryCode)
    } catch (e: NumberParseException) {
        System.err.println("NumberParseException was thrown: $e")
    }

    return if (swissNumberProto != null) phoneUtil.isValidNumber(swissNumberProto) else false
}

fun String.isValidPhone(selectedCountryCode: String): Boolean {
